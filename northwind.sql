...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2017 at 01:00 PM
...
(6, 'Company F', 'P?rez-Olaeta', 'Francisco', NULL, 'Purchasing Manager', '(123)555-0100', NULL, NULL, '(123)555-0101', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', NULL, NULL, ''),
...
INSERT INTO `notifications` (`notice_id`, `notification`) VALUES
('1', 'Academic year starts on <strong>12th July 2017</strong>.'),
('2', 'Mid sems will start on <strong>17th August 2017</strong>.'),
('3', 'Year ends on xx/xx/xxxxx');
...
(37, 8, 6, '2006-03-06 00:00:00', '2006-03-09 00:00:00', 2, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '12.0000', '0.0000', 'Credit Card', '2006-03-06 00:00:00', NULL, 0, NULL, 3),
...
(47, 6, 6, '2006-04-08 00:00:00', '2006-04-08 00:00:00', 2, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '300.0000', '0.0000', 'Credit Card', '2006-04-08 00:00:00', NULL, 0, NULL, 3),
...
(56, 2, 6, '2006-04-03 00:00:00', '2006-04-03 00:00:00', 3, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '0.0000', '0.0000', 'Check', '2006-04-03 00:00:00', NULL, 0, NULL, 3),
...
(64, 8, 6, '2006-05-09 00:00:00', '2006-05-09 00:00:00', 2, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '12.0000', '0.0000', 'Credit Card', '2006-05-09 00:00:00', NULL, 0, NULL, 0),
...
(74, 6, 6, '2006-06-08 00:00:00', '2006-06-08 00:00:00', 2, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '300.0000', '0.0000', 'Credit Card', '2006-06-08 00:00:00', NULL, 0, NULL, 3),
...
(79, 2, 6, '2006-06-23 00:00:00', '2006-06-23 00:00:00', 3, 'Francisco P?rez-Olaeta', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', '0.0000', '0.0000', 'Check', '2006-06-23 00:00:00', NULL, 0, NULL, 3),
...
INSERT INTO `privileges` (`id`, `privilege_name`, `col3`) VALUES
(2, 'something', NULL),
(4, 'Urjit', NULL);
...
CREATE TABLE IF NOT EXISTS `test` (
  ...
  `semester` int(4) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('1', '827ccb0eea8a706c4c34a16891f84e7b', 'Ram'),
('2', 'e2fc714c4727ee9395f324cd2e7f331f', 'Shyam');

-- --------------------------------------------------------

--
-- Table structure for table `user_bk`
--
...
--
-- Dumping data for table `user_bk`
--

INSERT INTO `user_bk` (`username`, `pass`, `name`) VALUES
('1', '827ccb0eea8a706c4c34a16891f84e7b', 'Ram'),
('2', 'e2fc714c4727ee9395f324cd2e7f331f', 'Shyam');
...
ALTER TABLE `customers`
  ADD PRIMARY KEY (`id`), ADD KEY `city` (`city`), ADD KEY `company` (`company`), ADD KEY `first_name` (`first_name`), ADD KEY `last_name` (`last_name`), ADD KEY `zip_postal_code` (`zip_postal_code`), ADD KEY `state_province` (`state_province`);
...
ALTER TABLE `employee_privileges`
  ADD PRIMARY KEY (`employee_id`,`privilege_id`), ADD KEY `employee_id` (`employee_id`), ADD KEY `privilege_id` (`privilege_id`), ADD KEY `privilege_id_2` (`privilege_id`);

--
-- Indexes for table `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
  ADD PRIMARY KEY (`id`), ADD KEY `customer_order_id` (`customer_order_id`), ADD KEY `customer_order_id_2` (`customer_order_id`), ADD KEY `product_id` (`product_id`), ADD KEY `product_id_2` (`product_id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `purchase_order_id_2` (`purchase_order_id`), ADD KEY `transaction_type` (`transaction_type`);
...
ALTER TABLE `invoices`
  ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `id_2` (`id`), ADD KEY `fk_invoices_orders1_idx` (`order_id`);
...
--
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `customer_id_2` (`customer_id`), ADD KEY `employee_id` (`employee_id`), ADD KEY `employee_id_2` (`employee_id`), ADD KEY `id` (`id`), ADD KEY `id_2` (`id`), ADD KEY `shipper_id` (`shipper_id`), ADD KEY `shipper_id_2` (`shipper_id`), ADD KEY `id_3` (`id`), ADD KEY `tax_status` (`tax_status_id`), ADD KEY `ship_zip_postal_code` (`ship_zip_postal_code`), ADD KEY `fk_orders_orders_status1` (`status_id`);
...
ALTER TABLE `order_details`
  ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `inventory_id` (`inventory_id`), ADD KEY `id_2` (`id`), ADD KEY `id_3` (`id`), ADD KEY `id_4` (`id`), ADD KEY `product_id` (`product_id`), ADD KEY `product_id_2` (`product_id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `id_5` (`id`), ADD KEY `fk_order_details_orders1_idx` (`order_id`), ADD KEY `fk_order_details_order_details_status1_idx` (`status_id`);
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`), ADD KEY `product_code` (`product_code`);

--
-- Indexes for table `purchase_orders`
--
ALTER TABLE `purchase_orders`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD KEY `created_by` (`created_by`), ADD KEY `status_id` (`status_id`), ADD KEY `id_2` (`id`), ADD KEY `supplier_id` (`supplier_id`), ADD KEY `supplier_id_2` (`supplier_id`);

--
-- Indexes for table `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
  ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `inventory_id` (`inventory_id`), ADD KEY `inventory_id_2` (`inventory_id`), ADD KEY `purchase_order_id` (`purchase_order_id`), ADD KEY `product_id` (`product_id`), ADD KEY `product_id_2` (`product_id`), ADD KEY `purchase_order_id_2` (`purchase_order_id`);
